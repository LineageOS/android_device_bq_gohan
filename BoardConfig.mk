...
# Surround sound recording is enabled in stock, but hal/audio_extn/surround_rec_interface.h is missing and needs to be reverse engineered first, see https://review.lineageos.org/#/c/155006/
...
# Sound trigger is enabled in stock, but hal/audio_extn/sound_trigger_prop_intf.h is missing and needs to be reverse engineered first
